...
//		protossList.add(highTemplar);
		...
		// starList는 StarUnit의 자식 객체들을 다 담 을 수 있다.
		// 담기면서 자동형변환 되어 담
		starList.add(zealot);
		...
		// HighTemplar (자식) 이ㅣ StarUnit (부모) 로
		// 형변환이 되어있기 때문에
		// 부모가 가지고 있지않은 메소드는 사용불가
//		starList.get(4).tthunderStrom();
