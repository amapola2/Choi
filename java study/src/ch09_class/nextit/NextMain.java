...
import ch09_class.typing.School.Student;
...
public class NextMain {
	...
	public static void main(String[] args) {
		...
		// 객체의 현재 상태를 한번에 보고싶다!!
		// 클래스 내에 toString() 메소드를 오버라이딩
		// syso내에 객체를 넣게되면, toString()의 실행결과가 
		// 콘솔창에 출력된다.
		System.out.println(jihye);
		System.out.println(jihye.toString());
		
		
		// 여러분들 짝꿍에 대해 객체로 만들어주시는데
		// 레벨과 경험치는 1과0으로 고정해서 만들어보세요
		// 두명이상 만들어보기 
		
		NextStudent changyeon = new NextStudent("창연" , 30, 1, 0);
		System.out.println(changyeon.toString());
		NextStudent jayoung = new NextStudent("자영", 30, 1 ,0);
		...
		NextStudent jayoung1 = new NextStudent("자영", 26);
		stuList.add(new NextStudent("자영", 26));
